...
alignment.csv: ia-oclc-lccn-issn-isbn.csv ia-volumes.csv hathifile.tsv book-aligner.rb
	./book-aligner.rb ia-oclc-lccn-issn-isbn.csv ia-volumes.csv hathifile.tsv > $@
...
ia-oclc-lccn-issn-isbn-vol-pub.csv:
	curl -o $@ 'https://archive.org/advancedsearch.php?q=mediatype%3Atexts&fl%5B%5D=identifier&fl%5B%5D=oclc-id&fl%5B%5D=lccn&fl%5B%5D=issn&fl%5B%5D=isbn&fl%5B%5D=volume&fl%5B%5D=published&sort%5B%5D=&rows=9999999&page=1&output=csv&save=yes'

ia-volumes.csv:
	curl -o $@ 'https://archive.org/advancedsearch.php?q=mediatype%3Atexts&fl%5B%5D=identifier&fl%5B%5D=volume&sort%5B%5D=&rows=9999999&page=1&output=csv&save=yes'
